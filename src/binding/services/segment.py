...
from binding.core.paths import binary_output_path, labeled_output_path
...
class SegmentResult:
    ...
    removed_count: int
    min_z_planes: int
    threshold_replaced_count: int
    threshold_yen_min: float
    threshold_yen_max: float
...
def run_segment(
    ...
    *,
    ...
    return SegmentResult(
        ...
        threshold_replaced_count=threshold_replaced_count,
        threshold_yen_min=min(thresholds),
        threshold_yen_max=max(thresholds),
    )